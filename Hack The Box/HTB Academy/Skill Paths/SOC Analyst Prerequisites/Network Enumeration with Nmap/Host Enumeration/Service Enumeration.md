...
```shell-session
secmancer@htb[/htb]$ sudo nmap 10.129.2.28 -p- -sV --stats-every=5s
...
```shell-session
secmancer@htb[/htb]$ sudo nmap 10.129.2.28 -p- -sV -v 
...
- #### Tcpdump
```shell-session
secmancer@htb[/htb]$ sudo tcpdump -i eth0 host 10.10.14.2 and 10.129.2.28
...
- #### Nc
```shell-session
secmancer@htb[/htb]$  nc -nv 10.129.2.28 25
